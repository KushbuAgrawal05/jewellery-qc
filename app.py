...
st.markdown(
    ...
    <style>
      ...
      html, body, [data-testid="stAppViewContainer"], [data-testid="stAppViewContainer"] > .main {
        background: radial-gradient(ellipse 120% 70% at 50% -10%, #ffffff 0%, var(--pearl) 60%);
        color: var(--ink);
      ...
      .gold-rule {
        height: 2px; margin: 1.75rem 0 2.25rem; border-radius: 2px;
        background: linear-gradient(90deg, var(--gold-deep) 0%, var(--gold-light) 55%, rgba(184,137,43,0) 100%);
      }
